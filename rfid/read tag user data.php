					...
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Family Name</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['fname'];?></td>
								</tr>
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Main Beneficiary Name</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['bname'];?></td>
								</tr>
								<tr>
								...
								<tr>
									<td align="left" class="lf">Proof</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['proof'];?></td>
								</tr>
								<tr>
